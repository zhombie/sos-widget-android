...
internal class SOSWidgetMessageContentView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        val view = inflate(context, R.layout.sos_widget_view_content, this)
        ...
        context.obtainStyledAttributes(attrs, R.styleable.SOSWidgetMessageContentView).use {
            when (it.getInt(R.styleable.SOSWidgetMessageContentView_sos_widget_theme_mode, -1)) {
                Theme.DARK -> {
