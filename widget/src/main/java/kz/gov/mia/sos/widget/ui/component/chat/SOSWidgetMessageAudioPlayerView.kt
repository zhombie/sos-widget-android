...
internal class SOSWidgetMessageAudioPlayerView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        val view = inflate(context, R.layout.sos_widget_view_audio_player, this)
        ...
        context.obtainStyledAttributes(attrs, R.styleable.SOSWidgetMessageAudioPlayerView).use {
            when (it.getInt(R.styleable.SOSWidgetMessageAudioPlayerView_sos_widget_theme_mode, -1)) {
                Theme.DARK -> {
                    background = it.getDrawable(R.styleable.SOSWidgetMessageAudioPlayerView_android_background)
                    ...
                    titleTextColor = ColorStateList.valueOf(
                        it.getColor(
                            R.styleable.SOSWidgetMessageAudioPlayerView_sos_widget_title_text_color,
                            Themes.getColor(context, Themes.Dark.titleTextColor)
                        )
                    )
                    timeTextColor = ColorStateList.valueOf(
                        it.getColor(
                            R.styleable.SOSWidgetMessageAudioPlayerView_sos_widget_time_text_color,
                            Themes.getColor(context, Themes.Dark.timeTextColor)
                        )
                    )
                    sliderInactiveTrackColor = it.getColorStateList(R.styleable.SOSWidgetMessageAudioPlayerView_sos_widget_slider_inactive_track_color)
                        ?: Themes.getColorAsColorStateList(
                            context,
                            Themes.Dark.sliderInactiveTrackColor
                        )
                    sliderActiveTrackColor = it.getColorStateList(R.styleable.SOSWidgetMessageAudioPlayerView_sos_widget_slider_active_track_color)
                        ?: Themes.getColorAsColorStateList(
                            context,
                            Themes.Dark.sliderActiveTrackColor
                        )
                    sliderThumbColor = it.getColorStateList(R.styleable.SOSWidgetMessageAudioPlayerView_sos_widget_slider_thumb_color)
    ...
    private sealed interface Themes {
        ...
        object Light : Themes {
            ...
            override val iconBackgroundColor: Int = R.color.sos_widget_purple_blue

            override val iconColor: Int = R.color.sos_widget_white
            ...
            override val timeTextColor: Int = R.color.sos_widget_dark_gray

            override val sliderInactiveTrackColor: Int = R.color.sos_widget_dark_gray

            override val sliderActiveTrackColor: Int = R.color.sos_widget_purple_blue

            override val sliderThumbColor: Int = R.color.sos_widget_purple_blue
        }

        object Dark : Themes {
            override val background: Int = R.drawable.sos_widget_ripple_top_right_rounded_transparent

            override val iconBackgroundColor: Int = R.color.sos_widget_white

            override val iconColor: Int = R.color.sos_widget_purple_blue
            ...
            override val timeTextColor: Int = R.color.sos_widget_white

            override val sliderInactiveTrackColor: Int = R.color.sos_widget_moderate_blue

            override val sliderActiveTrackColor: Int = R.color.sos_widget_white

            override val sliderThumbColor: Int = R.color.sos_widget_white
        }
    }
